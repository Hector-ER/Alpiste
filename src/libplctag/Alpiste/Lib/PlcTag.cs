...
namespace Alpiste.Lib
{
    ...
    */
    ...
    public static class LibPlcTag
    {
        ...
        public static Int32 plc_tag_create_ex(string attrib_str, callback_func_ex tag_callback_func, object userdata, int timeout)
        {
            try
            {
                PlcTag t = plc_tag_create_ex_(attrib_str, tag_callback_func, userdata, timeout);
                return t.tag_id;
            } catch (Exception e)
            {
                //  TODO: Dar resultados según el timpo de error.
                return Status.PLCTAG_ERR_CREATE;
            }
        }
        ...
        */
        ...
        public static int plc_tag_set_int32(Int32 id, int offset, Int32 ival)
        {
            ...
            else
            {
                if (val == 0)
                {
  //*HR*                  rc = plc_tag_set_bit(id, 0, 0);
                }
                else
                {
   //*HR*                 rc = plc_tag_set_bit(id, 0, 1);
                }
            }
 ...
 */
        ...
        public static int plc_tag_destroy(Int32 tag_id)
        {
            ...
            if (tag_id <= 0 || tag_id >= PlcTag.TAG_ID_MASK)
            {
            ...
            //lock (tags)
            {
                ...
                tag = null;
                weakReference?.TryGetTarget(out tag);
        ...
        static PlcTag plc_tag_create_ex_(string attrib_str, callback_func_ex tag_callback_func, object userdata, int timeout)
        {
            PlcTag tag = null;
            ...
            if ((attrib_str == null) || attrib_str.Length == 0)
            {
                ...
                throw new TagStringIsNullException();
            ...
            if (attribs == null)
            {
                ...
                throw new UnableToParseAttributeStringException();
             ...
             * to clone them.
             */
            tag_constructor tag_constructor = find_tag_create_func(attribs);
    ...
    public class AlpisteEventArgs : EventArgs
    {
        public EventType eventtype;
        public int status;
        public object userdata;
        public AlpisteEventArgs(EventType eventtype, int status, object userdata)
        {
    ...
    public delegate PlcTag tag_constructor(attr attributes, /*TagCallbackFunc*/ callback_func_ex tag_callback_func, Object userdata);
    ...
    public class PlcTag: Status, IDisposable
    {
       ...
       public  const int TAG_TICKLER_TIMEOUT_MIN_MS = 10;
        ...
        public void TagEventHandler(Object source, EventArgs eventArgs)
        {
            ...
            callback_func_ex callback_ = null;
            callback?.TryGetTarget(out callback_);
            if (callback_ != null)
            {
    ...
    //        //-----------------------------------------------------------------------
        ...
        static int initialize_modules_eliminar()
        {
            int rc = PLCTAG_STATUS_OK;
        ...
        //public static PlcTag plc_tag_create_ex_(string attrib_str, callback_func_ex tag_callback_func, object userdata, int timeout)
        //{
        //    PlcTag tag = null;
 ...
 //       #endregion
        ...
        public static void initialize_modules()
        {
         ...
         /*               lib_init();
            ...
            */
            ...
            lock (tags)
                cant_tags = tags.Count;
            if (cant_tags != 0 && !library_initialized)
            {
                lib_init();
                library_initialized = true;
            }
        ...
        public static tag_constructor find_tag_create_func(attr attributes)
        {
            ...
            if (protocol == null && make == "system")
            {
                throw new ProtocolNotImplementedException();
            }

            if (protocol == null || protocol == "ab-eip" || protocol == "ab_eip")
            {
                return AbTag.ab_tag_create;
            }
        ...
        */
        public int plc_tag_generic_init_tag(attr attribs, callback_func_ex tag_callback_func, object userData)
        {
            int rc = PLCTAG_STATUS_OK;
        ...
        public static int plc_tag_tickler_wake()
        {
            int rc = PLCTAG_STATUS_OK;
        ...
        static void tag_tickler_func()
        {
            ...
            while (/*!library_terminating*/ cant_tags > 0)
            {
                ...
                foreach (WeakReference<PlcTag> weakTag in tags_array)
                {
                    ...
                    // Aunque el compilador diga que esta instrucción es innecesaria, no es así.
                    // Si esta instrucción no está, el garbage collector nunca llamará al destructor.del tag.
                    tag = null;
...
*/
        ...
        public delegate void EventDelegate(object sender, AlpisteEventArgs args);

        //public delegate void EventDelegate_(int status, object userdata);

        public event EventDelegate ReadCompleted;
        public event EventDelegate WriteCompleted;
        public event EventDelegate Created;
        public event EventDelegate ReadStarted;
        public event EventDelegate WriteStarted;
        public event EventDelegate Aborted;
        public event EventDelegate Destroyed;
            ...
            lock(this.api_mutex)
                ...
                if (callback!=null)
                {
                    ...
                    if (event_creation_complete)
                    {
                        ...
                        Created?.Invoke(this, new AlpisteEventArgs(EventType.PLCTAG_EVENT_CREATED, event_creation_complete_status, userdata));
                    ...
                    if (event_read_started)
                    {
                        ...
                        ReadStarted?.Invoke(this, new AlpisteEventArgs(EventType.PLCTAG_EVENT_READ_STARTED,event_read_started_status, userdata));
                    ...
                    if (event_write_started)
                    {
                        ...
                        WriteStarted?.Invoke(this, new AlpisteEventArgs(EventType.PLCTAG_EVENT_WRITE_STARTED,event_write_started_status, userdata));
                    ...
                    if (event_operation_aborted)
                    {
                        ...
                        Aborted?.Invoke(this, new AlpisteEventArgs(EventType.PLCTAG_EVENT_ABORTED, event_operation_aborted_status, userdata));
                    ...
                    if (event_read_complete)
                    {
                        ...
                        ReadCompleted?.Invoke(this, new AlpisteEventArgs(EventType.PLCTAG_EVENT_READ_COMPLETED, event_read_complete_status, userdata));
                    ...
                    if (event_write_complete)
                    {
                        ...
                        WriteCompleted?.Invoke(this, new AlpisteEventArgs(EventType.PLCTAG_EVENT_WRITE_COMPLETED, event_write_complete_status, userdata));
                    ...
                    if (event_deletion_started)
                    {
                        ...
                        Destroyed?.Invoke(this, new AlpisteEventArgs(EventType.PLCTAG_EVENT_DESTROYED, event_deletion_started_status, userdata));
